...
def train(model, cfg, device):
  wandb.init(project='3ball_CAP', entity='hails', name='TransD_20x20_1e7',config={
    "batch_size": cfg.train.batch_size,
    "model_lr" : cfg.optimize.model_lr,
    "value_lr" : cfg.optimize.value_lr,
    "actor_lr" : cfg.optimize.actor_lr,
    "rl_discount":cfg.rl.discount,
  ...
  print("max_steps :", cfg.env.max_steps)
  print("roomsize is : 20")
